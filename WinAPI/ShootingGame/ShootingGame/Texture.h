...
public:
	...
	void Load(wstring path, int32 maxCountX, int32 maxCountY, int32 transparent, float dur);
	void Render(HDC hdc, Pos pos, Pos srcPos);
	...
	void SetCameraApply(bool apply) { _cameraApply = apply; }
